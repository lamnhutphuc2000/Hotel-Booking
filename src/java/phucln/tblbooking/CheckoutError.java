...
public class CheckoutError implements Serializable{
    private String roomOutOfStockError;
    ...
    public CheckoutError(String roomOutOfStockError, String checkInDateFormatError, String checkOutDateFormatError, String checkOutBeforeCheckInError, String checkInDateBeforeNowError, String checkOutDateBeforeNowtError) {
        this.roomOutOfStockError = roomOutOfStockError;
    ...
    /**
     * @return the roomOutOfStockError
     */
    public String getRoomOutOfStockError() {
        return roomOutOfStockError;
    }

    /**
     * @param roomOutOfStockError the roomOutOfStockError to set
     */
    public void setRoomOutOfStockError(String roomOutOfStockError) {
        this.roomOutOfStockError = roomOutOfStockError;
    }
